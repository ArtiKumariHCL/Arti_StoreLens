...
public class PowerAppsAutomateFlowPage {
	...
	public PowerAppsAutomateFlowPage(WebDriver driver) {
	 ...
	 public void clickOnSolutions(String pagename)
	    {
	    	Wait.elementToBeClickable(driver, driver.findElement(By.xpath("(//span[text()='"+pagename+"'])[1]")), 80);
			testutil.actionMethodClick(driver, driver.findElement(By.xpath("(//span[text()='"+pagename+"'])[1]")));
	    	
	    	driver.findElement(By.xpath("(//span[text()='"+pagename+"'])[1]")).click();
