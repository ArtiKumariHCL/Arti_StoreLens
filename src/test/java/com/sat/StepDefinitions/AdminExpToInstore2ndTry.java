...
public class AdminExpToInstore2ndTry {
	...
	@And("user fil details {string},{string},{string},{string},{string},{string},{string}")
	public void clickng_on_and_fil_details_and_save_it(String brand, String gender, String category,
			String size, String condition, String material, String price) throws InterruptedException {
		resalelogin.brandSelection(brand);
		resalelogin.genderSelection(gender);
		resalelogin.categorySelection(category);
		resalelogin.sizeSelection(size);
